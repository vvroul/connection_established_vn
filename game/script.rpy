...
label start:
    ...
    label timeForShow : 
        ...
        label kageLate : 
            aki "Kage..."
            aki "Όλοι ξέρουμε πως άργησες να έρθεις στο μέρος συνάντησής μας, περίπου 45 λεπτά."
            aki "Eίχαμε συμφωνήσει να είμαστε έξω από το κτήριο εκείνη την ώρα σε περίπτωση αναμονής στην ουρά."
            aki "Τι έχεις να πεις γι'αυτό;"
            kana "Όντως ο Kage άργησε πάρα πολύ! Αυτός είναι ψεύτικος!"
            mio "Οι υπόλοιποι ήμασταν εδώ και τον περιμέναμε...δεν μπορεί..."
            gou "Περιμένετε..."
            gou "Έχω και γω μια πρόταση, οπότε ας μην βιαστούμε στο να βγάλουμε γρήγορα συμπεράσματα"
            kage "Χμ...αν πιστεύετε πως εγώ είμαι ψεύτικος, τότε νομίζω πως είμαστε τελειωμένοι..."
            mio "Εξήγησέ μας."
            kage "Aki. Καταλαβαίνω τις ανηχυχίες σου για μένα, αλλά μετά από τη συζήτηση που κάναμε προηγουμένως δεν πίστευα πως θα με υποψιαζόσουν."
            kage "Αρχικα, δεν ήμουν σίγουρος για το αν θα ερχόμουν να παρακολουθήσω τη μάχη. Αυτό που μου άλλαξε γνώμη ήταν μια φωτογραφία."
            kage "Στην φωτογραφία απεικονίζεται η Aki με μια μηχανή-ρομπότ, που κατά πάσα πιθανότητα δημιουργούσε εκείνη΄τη στιγμή."
            kana "Και τι με αυτό;"
            kage "Βγαίνοντας από το σπίτι και καθώς έτρεχα για να προλάβω την μάχη, συνάντησα την Aki στο δρόμο..."
            kage "Και μιλήσαμε για το ρομπότ που αναπτύσσει καθώς και διάφορες άλλες τεχνικές για το πως κανείς μπορεί να προσομοιώσει αυτή τη μάχη"
            mio "Μα...περίμενε. Δεν μπορεί...Η Aki ήταν εδώ μαζί μας όλη την ώρα."
            kage "Ναι...η ψεύτικη!! Γι'αυτό κατηγόρησε εμένα πρώτα γιατί θέλει να μας ξεφορτωθεί έναν έναν χωρίς να το καταλάβουμε..."
            kana "Εδώ είναι που κάνεις εσύ λάθος Kage, δεν μπορεί να ήταν η ψεύτικη και μπορώ να σου αποδείξω το γιατί."
            networker "Χμ...απ'ότι φαίνεται να τους υποτίμησα. Ήδη έχουν βάλει στο τραπέζι παραπάνω επιχειρήματα από αυτά που περίμενα."
            kana "Γνωρίζω και γω την ασχολία της Aki που ανέφερες με το συγκεκριμένο ρομπότ. Για την ακρίβεια, ήμουν στο σπίτι της μόλις ξεκίνησε να το φτιάχνει."
            kana "Εκείνη την ημέρα έθεσε το ρομπότ αυτό εκτός λειτουργίας ενώ έβγαλε ένα κύριο μέρος του που προοριζόταν για αναβάθμιση."
            kana "Η αναβάθμιση είχε ολοκληρωθεί μέχρι χθες και σήμερα το ρομπότ μπορούσε να μετακινηθεί στους δρόμους και να αλληλεπιδράσει με τον οποιονδήποτε."
            gou "Και μας λες πως είναι τόσο προχωρημένο τεχνολογικά έτσι ώστε να συζητήσει με τον Kage χωρίς να το καταλάβει ο ίδιος;"
            kana "Αυτό μπορείς να το ρωτήσεις στην ίδια την Aki. Έχει κάνει πραγματικά σπουδαία δουλειά."
            kana "Οπότε το επιχείρημά σου για την ψεύτικη Aki, δεν ισχύει."
            networker "..."
            mio "Gou..."
            mio "Πιστεύω πως εσύ είσαι ο ψεύτικος. Πριν έρθει ο Kage, μπήκες μέσα στην σκηνή χωρίς να περιμένεις."
            mio "Υπάρχουν μεγάλες πιθανότητες να πιάστηκες από τον Networker."
            mio "Επιπλέον προσπαθήσεις όλη αυτήν την ώρα να προστατέψεις τον Kage γιατί ήταν ο μόνος που σε είδε."
            gou "Τι;"
            kage "..."
            mio "Μου το είπε πριν αρχίσει το show πως σε είδε ενώ ερχόταν εδώ."
